...
class App extends Component {
  ...
  loadMap = () => {
    loadScript(
      `https://maps.googleapis.com/maps/api/js?key=AIzaSyB0QcA4IRQWY57Qncqo-hwN0qc6NHmxZlA&callback=initMap`
    )
  ...
  initMap = () => {
    ...
    const map = new window.google.maps.Map(document.getElementById("map"), {
      center: { lat: 39.912140, lng: 116.497269 },
      zoom: 14,
      styles: [
        {
    ...
    this.state.venues.forEach((index) => {
      let position = {
  ...
  getVenues = () => {
    ...
    const parameters = {
      client_id: "LORDZQRPFG4G1ZURGO0YKGXALSPDIQLH4RQI5HHCY1UEJEP4",
      client_secret: "3YP2M10ELBURGSZT4NQQVDJRJ2REOVIUP55P5ZYHHEDDJYZC",
      query: "Coffee",
      section: "",
      near: "八里庄东里, Beijing Shi",
      v: "20181008",
    }
